...
public:
	...
	virtual bool getIntersection(const Point3D& raySrc, const Vector3D& rayDir, float& distToFirstIntersection, Vector3D& normalDirection) const = 0;
...
public:
	...
	virtual bool getIntersection(const Point3D& raySrc, const Vector3D& rayDir, float& distToFirstIntersection, Vector3D& PlaneNormalDirection) const;
...
public:
	...
	// Task 4 adding the normalDirection as a output.
	virtual bool getIntersection(const Point3D& raySrc, const Vector3D& rayDir, float& distToFirstIntersection, Vector3D& normalDirection) const;
	virtual void applyTransformation(const Matrix3D& matrix);
