...
struct ObjectInfo
{
	...
	Vector3D normalAtIntersectionPoint;

	//Task 4 normalAtIntersectionPoint
	ObjectInfo(const Object* obj = nullptr, float d = FLT_MAX, Vector3D normal = Vector3D(0,0,0))
		: object(obj), distanceToIntersection(d), normalAtIntersectionPoint(normal) {}
};
...
public:
	...
	//const Vector3D& GetPixelNormal(Vector3D& PlaneDirection);
